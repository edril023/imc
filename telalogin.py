...
class PlannerApp(App):
    def build(self):
        ...
        self.toggle_button = ImageButton(
            source='C:/Users/assir/OneDrive/Área de Trabalho/projeto/planner/fechado.png', size_hint=(None, None), size=(25, 25),
            pos_hint={'center_x': 0.88, 'center_y': 0.9}, on_press=self.toggle_password_visibility
        )
        ...
        self.submit_button.pos_hint = {'center_x': 0.756, 'center_y': 0.6}
        ...
        self.forgot_password_label = ClickableLabel(
            ...
            pos_hint={'center_x': 0.35, 'center_y': 0.59}, color=(1, 0.65, 0.4), font_size=13
        )
    ...
    def toggle_password_visibility(self, instance):
        ...
        if self.peso_input.password:
            self.toggle_button.source = 'C:/Users/assir/OneDrive/Área de Trabalho/projeto/planner/fechado.png'
        else:
            self.toggle_button.source = 'C:/Users/assir/OneDrive/Área de Trabalho/projeto/planner/aberto.png'
